            ...
            contents: [
                {
                    ...
                    id: 'tab-basic',
                    label: editor.lang.footnotes.dialog.label,
                    ...
                    elements: [
                        {
                            ...
                            id: 'new_footnote',
                            'class': 'footnote_text',
                            label: editor.lang.footnotes.dialog.new,
                        ...
                        },
                        {
                            ...
                            id: 'footnote_id',
                            name: 'footnote_id',
                            label: editor.lang.footnotes.dialog.nocontent,
                            ...
                            setup: function( element ) {
                                ...
                                if ($footnotes.length > 0) {
                                    if ($el.find('p').length == 0) {
                                        $el.append('<p style="margin-bottom: 10px;"><strong>'+editor.lang.footnotes.dialog.or+':</strong> '+editor.lang.footnotes.dialog.choose+'</p><ol class="footnotes_list"></ol>');
                                    } else {
                                        $el.find('ol').empty();
                                    }
